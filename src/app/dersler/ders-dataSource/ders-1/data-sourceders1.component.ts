...
@Component({
  selector: 'app-data-sourceders1',
  templateUrl: './data-sourceders1.component.html',
  styleUrls: ['./data-sourceders1.component.css']
})
export class DataSourceders1Component implements OnInit {
